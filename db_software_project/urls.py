...
urlpatterns = [
    ...
    path(
        "add_sortofsoftware/",
        SortOfSoftwareAddView.as_view(),
        name="add_sortofsoftware",
    ),
    path(
        "sortofsoftware_list/",
        SortOfSoftwareListView.as_view(),
        name="sortofsoftware_list",
    ),
    path(
        "request_delete/<int:pk>/",
        SoftRequestDeleteView.as_view(),
        name="request_delete",
    ),
    path(
        "request_update/<int:pk>/",
        UpdateSoftRequestView.as_view(),
        name="request_update",
    ),
    path(
        "search_software/",
        SearchSoftwareView.as_view(),
        name="search_software",
    ),
    path(
        "request/add/",
        SoftRequestCreateView.as_view(),
